...
%If we have a hash function $h$ that is collision resistant, an attacker
%cannot find any two messages with the same image under this function faster
%than using brute force (hashing messages until they find a collision). If
%such an attacker knows of a message and its corresponding hash.
%4.a - contrapositive
\begin{enumerate}
